...
using FBeaulieu.BinCleaner;

namespace BinCleaner_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new BinCleanerPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(FBeaulieu.BinCleaner.GuidList.guidBinCleanerCmdSet, (int)FBeaulieu.BinCleaner.PkgCmdIDList.cleanBinObj);

...
namespace BinCleaner_IntegrationTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(FBeaulieu.BinCleaner.GuidList.guidBinCleanerCmdSet, (int)FBeaulieu.BinCleaner.PkgCmdIDList.cleanBinObj);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "BinCleaner", "FBeaulieu.BinCleaner.BinCleanerPackage");
